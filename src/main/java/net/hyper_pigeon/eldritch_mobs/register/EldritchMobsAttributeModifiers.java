...
import net.hyper_pigeon.eldritch_mobs.component.MutableEntityAttributeModifier;
...
//            EntityAttributeModifier.Operation.fromId(1));
    ...
    public static final MutableEntityAttributeModifier ELDRITCH_HEALTH_BOOST = new MutableEntityAttributeModifier("eldritch.health_boost", 1.0d, EntityAttributeModifier.Operation.MULTIPLY_BASE);
}
